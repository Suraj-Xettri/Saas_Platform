...
const Header = () => {
  ...
  return (
    <header
      className={clsx(
        "fixed top-0 left-0 z-50 w-full py-7 transition-all duration-500 max-lg:py-4",
        hasScrolled && "py-2 bg-black-100 bg-blur-[8px] "
      )}
    >
          ...
          <div className="w-full max-lg:relative max-lg:flex max-lg:flex-col max-lg:min-h-screen max-lg:p-4 max-lg:justify-center max-lg:overflow-hidden max-md:px-1 ">
            ...
            <div className="lg:hidden block absolute top-1/2 left-0 w-[960px] h-[380px] translate-x-[-290px] -translate-y-1/2 rotate-90">
              ...
              <img
                ...
                height={380}
                alt="outline"
                className="absolute insect-0 mix-blend-soft-light opacity-5"
              />
            </div>
          </div>
        </div>
